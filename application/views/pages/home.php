                ...
                <?php if($produtos != null): ?>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <img src="<?php echo base_url("assets/img/produtos/MOTO-G-2.png") ?>" alt="" / width="150">
                            <div class="caption">
                                <h3><a href="#"><?php echo $produto->ProdNome; ?></a></h3>
                                <p>Preço: <strong>R$ <?php echo $this->cart->format_number($produto->PrecoVenda); ?></strong>  </p>
                                <p><a href="#">Ptional dismiss button </a></p>
                                <p><?php echo $produto->Descricao; ?>  </p>
                                <p><a href="<?php echo base_url("carrinho/AdicionarCarrinho/".$produto->ProdutoId."/".filter_var($produto->ProdNome,FILTER_SANITIZE_URL))  ?>" class="btn btn-success" role="button">Adicionar ao carrinho</a> <a href="#" class="btn btn-primary" role="button">Mais Detalhes</a></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
